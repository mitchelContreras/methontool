...
public class Regla {
	...
	public Regla(int id, int idGlosarioRegla, String expresion,
		...
		super();
		this.id = id;
		this.idGlosarioRegla = idGlosarioRegla;
	...
	public int getIdGlosarioRegla() {
		return idGlosarioRegla;
	}

	public void setIdGlosarioRegla(int idGlosarioRegla) {
		this.idGlosarioRegla = idGlosarioRegla;
	}
