...
angular.module('methontool')
	...
	.factory('FactoryMedida', FactoryMedida);


	FactoryMedida.$inject = ['$listarMedida'];

	function FactoryMedida (
			$listarMedida
			){
		...
		function getListaElemento(){
			if (yaConsulte){
				...
				$listarMedida.get().$promise.then(
		                function(salida) {
		                   // success
		                    if(salida.succes){
		                    	console.log("listarMedida succes es true");
		                    	yaConsulte = true;
